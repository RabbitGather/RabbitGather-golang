...
const (
	InterestCrawler_Crawl_FullMethodName = "/InterestCrawler/Crawl"
)
...
func (c *interestCrawlerClient) Crawl(ctx context.Context, in *CrawlRequest, opts ...grpc.CallOption) (*CrawlResponse, error) {
...
func (UnimplementedInterestCrawlerServer) Crawl(context.Context, *CrawlRequest) (*CrawlResponse, error) {
